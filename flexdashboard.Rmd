...
inspection_df %>% 
  ...
  layout(
    title = "Top 5 Most Common Cuisines in Queens ",
...
inspection_df %>%
  ...
  plot_ly(
    x = ~inspection_date, y = ~score, type = "scatter", mode = "markers", color = ~boro, colors = "viridis", text = ~text_label, alpha = 0.75) %>% 
  layout(
    title = "Changes NYC Restaraunt Scores from 2014-2018",
